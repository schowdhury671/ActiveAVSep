    ...
    if (
        ...
        if IS_MOVING_SOURCE:
            if 'val' in sim_config.AUDIO.DATASET_SPLIT:
                ...
                f_name = '/fs/nexus-projects/ego_data/active_avsep/active-AV-dynamic-separation/data/active_datasets/v1_old/test_1000episodes/content/'+episode.scene_id.split('/')[-2]+'_moving_source.json.gz'
