...
_C = CN()
_C.SEED = 0
_C.BASE_TASK_CONFIG_PATH = "configs/tasks/pretrain_passive.yaml"	# pointnav (github), pretrain_passive
...
# -----------------------------------------------------------------------------
# GROUND TRUTH DELTAX DELTAY SENSOR
# -----------------------------------------------------------------------------
_TC.TASK.GT_DELTAX_DELTAY_SENSOR = CN()
...
_TC.SIMULATOR.AUDIO.DATASET_SPLIT = "train"
